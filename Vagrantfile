...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "~/kalabox/www", "/var/www", :create => true, :nfs => true, :nfs_version => "3"
  config.vm.synced_folder "~/kalabox/drush_aliases", "/etc/drush/aliases", :create => true, :nfs => true, :nfs_version => "3"
